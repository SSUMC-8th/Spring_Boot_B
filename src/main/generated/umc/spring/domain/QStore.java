...
public class QStore extends EntityPathBase<Store> {
    ...
    public final ListPath<SalesTime, QSalesTime> salesTimeList = this.<SalesTime, QSalesTime>createList("salesTimeList", SalesTime.class, QSalesTime.class, PathInits.DIRECT2);
